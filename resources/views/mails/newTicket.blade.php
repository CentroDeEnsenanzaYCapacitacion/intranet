                                    ...
                                    <td style="padding: 24px 0;">
                                        <div style="background: #FFF8F0; border: 1px solid #CFAF94; border-radius: 12px; padding: 24px;">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                            <tr>
                                                                <td width="50%" style="padding-right: 8px;">
                                                                    ...
                                                                    <p style="margin: 0; color: #3B2F2F; font-size: 14px; font-weight: 500; text-transform: capitalize;">
                                                                        {{ $ticket->priority }}
                                                                    </p>
                                                                </td>
                                                                <td width="50%" style="padding-left: 8px;">
                                                                    ...
                                                                    <p style="margin: 0; color: #3B2F2F; font-size: 14px; font-weight: 500;">
                                                ...
                                                <tr>
                                                    <td style="border-top: 1px solid #E5E7EB; padding-top: 16px;">
                                                        <p style="margin: 0 0 8px; color: #8B6B5A; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">
                                                            Descripción
                                                        </p>
                                                        <div style="background: white; padding: 12px; border-radius: 8px; border: 1px solid #E5E7EB;">
                                                            <p style="margin: 0; color: #3B2F2F; font-size: 14px; line-height: 1.6;">
                                                                {{ $ticket->description }}
                                                            </p>
                                                        </div>
                                                    </td>
