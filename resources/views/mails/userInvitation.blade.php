                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 24px; color: #666666; font-size: 15px; line-height: 1.6;">
                                Tu cuenta ha sido creada exitosamente. Para acceder al sistema, primero debes establecer tu contraseña.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 16px;">
                                        <p style="margin: 0 0 12px; color: #666666; font-size: 14px; line-height: 1.6;">
                                            <strong style="color: #f37021;">Importante:</strong> Este enlace es válido por 7 días. Si no estableces tu contraseña dentro de este período, deberás solicitar una nueva invitación.
                                        </p>
                                        <p style="margin: 0; color: #999999; font-size: 12px; line-height: 1.6;">
                                            Si no puedes hacer clic en el botón, copia y pega este enlace en tu navegador:<br>
                                            <span style="word-break: break-all; color: #666666;">{{ $invitationUrl }}</span>
                                        </p>
                                    </td>
                                </tr>
                            </table>
