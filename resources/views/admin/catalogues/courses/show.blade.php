...
@section('content')
    <div class="dashboard-welcome">
        <h1 class="dashboard-title">Gestión de Cursos</h1>
        <p class="dashboard-subtitle">Administra los programas académicos del sistema</p>
    </div>
    ...
    <div class="modern-card">
        <div class="card-header-modern">
            ...
            <a href="{{ route('admin.catalogues.courses.new') }}" class="btn-modern btn-primary" onclick="showLoader(true)">
            ...
            <table class="modern-table">
                ...
                <tbody>
                    @foreach ($courses as $course)
                        <tr>
                            <td class="text-uppercase font-medium">{{ $course->name }}</td>
                            <td>
                                <span class="badge badge-primary">{{ $course->crew->name }}</span>
                            </td>
                            <td>
                                <div class="action-buttons">
                                    @if ($role != 1)
                                        @if ($course->id > 22)
                                            <a href="{{ route('admin.catalogues.courses.edit', ['id' => $course->id]) }}"
                                        ...
                                        @else
                                            <button class="action-btn" disabled title="Curso protegido" style="opacity: 0.4; cursor: not-allowed;">
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
