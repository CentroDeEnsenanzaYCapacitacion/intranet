...
@section('content')
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="modern-field">
                            ...
                            <select class="form-select modern-input text-uppercase" name="difficulty" id="difficulty" required>
                                <option value="facil" {{ $question->difficulty == 'facil' ? 'selected' : '' }}>F&aacute;cil</option>
                                <option value="medio" {{ $question->difficulty == 'medio' ? 'selected' : '' }}>Medio</option>
                                <option value="dificil" {{ $question->difficulty == 'dificil' ? 'selected' : '' }}>Dif&iacute;cil</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="modern-field">
                            ...
                            <textarea class="form-control modern-textarea" id="question_text" name="question_text" rows="3" required>{{ $question->question_text }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="modern-field">
                            ...
                            <textarea class="form-control modern-textarea" id="explanation" name="explanation" rows="2">{{ $question->explanation }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row d-flex align-items-center mt-2 option-row" data-option="{{ $index }}">
                        <div class="col-auto pr-2">
                            <input class="form-check-input correct-radio" type="radio" name="correct_option"
                                   value="{{ $index }}" {{ $option->is_correct ? 'checked' : '' }} required>
                        </div>
                        <div class="col">
                            <input type="text" class="form-control modern-input option-input"
                                   name="options[{{ $index }}][text]"
                                   placeholder="Opci&oacute;n {{ $index + 1 }}"
    ...
    @push('scripts')
    <script>
        window.initialOptionCount = {{ count($question->options) }};
    </script>
    ...
    <div class="modern-card" style="margin-bottom: 24px;">
        ...
        <div style="padding: 24px;">
            <div class="row">
                <div class="col-md-8 mb-3">
                    <div class="modern-field">
                        <label style="font-weight: 600;">Materia (Bachillerato)</label>
                        <p class="text-uppercase" style="font-size: 14px; color: #1f2937; margin: 8px 0 0 0;">{{ $question->subject->name }}</p>
                    </div>
                </div>

                <div class="col-md-4 mb-3">
                    <div class="modern-field">
                        <label style="font-weight: 600;">Dificultad</label>
                        @php
                            $difficultyClass = '';
                            $difficultyText = '';
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="modern-field">
                        <label style="font-weight: 600;">Pregunta</label>
                        <p style="font-size: 14px; color: #1f2937; margin: 8px 0 0 0;">{{ $question->question_text }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="modern-field">
                        <label style="font-weight: 600;">Explicación</label>
                        <p style="font-size: 14px; color: #1f2937; margin: 8px 0 0 0;">{{ $question->explanation }}</p>
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="modern-field">
                        <label style="font-weight: 600;">Creado por</label>
                        <p style="font-size: 14px; color: #1f2937; margin: 8px 0 0 0;">{{ $question->creator->name }} {{ $question->creator->surnames }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modern-card" style="margin-bottom: 24px;">
        ...
        <div style="padding: 24px;">
            ...
            <div class="row d-flex align-items-center mt-2">
                ...
                <div class="col">
                    <p style="margin: 0; font-size: 14px; color: {{ $option->is_correct ? '#065f46' : '#1f2937' }}; font-weight: {{ $option->is_correct ? '600' : '400' }};">
                        {{ $option->option_text }}
                    </p>
                </div>
            </div>
