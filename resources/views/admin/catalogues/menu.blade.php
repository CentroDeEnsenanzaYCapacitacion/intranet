...
<div class="row d-flex text-center mt-content">
    <div class="col">
        <a id='adminCourses' href="{{ route('admin.catalogues.courses.show') }}"><img class="menu_icon" src="{{ asset('img/courses.png') }}"></a><br>
        Cursos
    </div>
    <div class="col">
        <a id='adminAmounts' href="../admin/adminAmounts.php"><img class="menu_icon" src="{{ asset('img/prices.png') }}"></a><br>
        Costos
    </div>
    <!--<div class="col">
