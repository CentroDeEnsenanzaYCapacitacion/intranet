                                ...
                                <tr>
                                    ...
                                    <td class="justify-content-center">
                                        <span class="material-symbols-outlined bg-edit"><a onclick="showLoader(true)"
                                                href="{{ route('admin.users.edit', ['id' => $user->id]) }}">edit</a></span>
                                        <form method="POST" action="{{ route('admin.users.block', ['id' => $user->id]) }}"
                                            ...
                                            <span class="material-symbols-outlined bg-red"><a
                                                    onclick="confirmDelete('user',{{ $user->id }})">block</a></span>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
                        ...
                        <tbody>
                            @foreach ($blocked_users as $user)
                                <tr>
                                    ...
                                    <td class="justify-content-center">
                                        <span class="material-symbols-outlined bg-edit"><a onclick="showLoader(true)"
                                                href="{{ route('admin.users.activate', ['id' => $user->id]) }}">restart_alt</a></span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
