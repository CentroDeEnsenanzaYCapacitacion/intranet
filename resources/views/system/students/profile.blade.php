                ...
                <div class="col">
                    <div class="text-start text-uppercase">
                        <form method="POST" action="{{ route('system.student.update') }}">
                            ...
                            <input type="hidden" name="payment_periodicity_id"
                                value="{{ $student->payment_periodicity_id }}" />
                            ...
                            <b>Dirección: </b><input class="form-control text-uppercase" name="address" type="text"
                                value="{{ old('address', $student->address) }}" /> <br>
                            <b>Colonia: </b><input class="form-control text-uppercase" name="colony" type="text"
                                value="{{ old('colony', $student->colony) }}" /><br>
                            <b>Municipio: </b><input class="form-control text-uppercase" name="municipality" type="text"
                                value="{{ old('municipality', $student->municipality) }}" /><br>
                            <b>C.P.: </b><input class="form-control text-uppercase" name="pc" type="text"
                                value="{{ old('pc', $student->PC) }}" /><br>
                            <b>Género: </b>
                            @if ($student->genre == 'M')
                                Mujer
                            ...
                            @endif
                            <br>
                            <b>Teléfono: </b><input class="form-control text-uppercase" name="phone" type="text"
                                value="{{ old('phone', $student->phone) }}" /><br>
                            <b>Celular: </b><input class="form-control text-uppercase" name="cel_phone" type="text"
                                value="{{ old('cel_phone', $student->cel_phone) }}" /><br>
                            <b>Correo electrónico: </b><input class="form-control text-uppercase" name="email"
                                type="text" value="{{ old('email', $student->email) }}" /><br><br>
                            ...
                            <div>
                                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" value="false" class="btn-check text-uppercase" name="sabbatine"
                                        id="sabf" autocomplete="off"
                                        {{ old('sabbatine', $student->sabbatine == 0 ? 'false' : '') == 'false' ? 'checked' : '' }}>
                                    ...
                                    <input type="radio" value="true" class="btn-check text-uppercase"
                                        ...
                                        {{ old('sabbatine', $student->sabbatine == 1 ? 'true' : '') == 'true' ? 'checked' : '' }}>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-outline-orange btn-sm ms-3"
                                    onclick="openModal('tuitionChangeModal')">Solicitar cambio</button>
                            </div><br>
                            <div class="form-group">
                                ...
                                <select class="form-control text-uppercase" name="modality_id" id="modality_id">
                                    @foreach ($modalities as $modality)
                                        <option value="{{ $modality->id }}"
                                            {{ old('modality_id', $student->modality_id) == $modality->id ? 'selected' : '' }}>
                            ...
                            <b>Nombre: </b><input class="form-control text-uppercase" name="tutor_name" type="text"
                                value="{{ old('tutor_name', $student->tutor->tutor_name) }}" /><br>
                            <b>Apellidos: </b><input class="form-control text-uppercase" name="tutor_surnames"
                                type="text"
                                value="{{ old('tutor_surnames', $student->tutor->tutor_surnames) }}" /><br>
                            <b>Teléfono: </b><input class="form-control text-uppercase" name="tutor_phone" type="text"
                                value="{{ old('tutor_phone', $student->tutor->tutor_phone) }}" /><br>
                            <b>Celular: </b><input class="form-control text-uppercase" name="tutor_cel_phone"
                                type="text"
                                value="{{ old('tutor_cel_phone', $student->tutor->tutor_cel_phone) }}" /><br>
                            <b>Parentesco: </b><input class="form-control text-uppercase" name="relationship"
                                type="text"
                                value="{{ old('tutor_relationship', $student->tutor->relationship) }}" /><br><br>
                            ...
                            <div class="d-flex justify-content-center mt-3"><button class="btn bg-orange text-white"
                                    type="submit" onclick="showLoader(true)">Actualizar datos</button></div><br><br>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="custom-modal-content">
            ...
            <form method="POST" action="{{ route('system.student.request-tuition-change') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="new_tuition" name="new_tuition" step="0.01"
                        min="0.01" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mt-4 text-end">
                    <button type="button" class="btn btn-secondary me-2"
                        onclick="closeModal('tuitionChangeModal')">Cancelar</button>
