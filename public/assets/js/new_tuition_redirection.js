        ...
        if (newTab) {
            const formHtml = `
                    <form action="${escapeAttributes(form.action)}" method="post">
                        ...
                        <input type="hidden" name="student_id" value="${escapeAttributes(
                        ...
                        <input type="hidden" name="receipt_type_id" value="${escapeAttributes(
                            document.querySelector(
                                'select[name="receipt_type_id"]'
                            ).value
                        )}">
                        <input type="hidden" name="attr_id" value="${escapeAttributes(
                            document.querySelector('select[name="attr_id"]')
                                .value
                        )}">
                        <input type="hidden" name="receipt_amount" value="${escapeAttributes(
                            document.querySelector(
                                'input[name="receipt_amount"]'
                            ).value
                        )}">
                        <input type="hidden" name="card_payment" value="${escapeAttributes(
                            document.querySelector('input[name="card_payment"]')
                                .checked
                                ? "card"
                                : ""
                        )}">
                        <input type="hidden" name="voucher" value="${escapeAttributes(
                            document.querySelector('input[name="voucher"]')
                                .value
                        )}">
                        <input type="hidden" name="bill" value="${escapeAttributes(
