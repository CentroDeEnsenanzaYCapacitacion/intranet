    ...
    document.getElementById('noDiscountForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.isValid) {
                ...
                displayError('No existe un costo regostrado para el recibo que se intenta emitir, o el costo es 0, por favor, registre un costo para continuar.');
            }
        })
        .catch(error => {
...
function displayError(message) {
    ...
    errorList.innerHTML = `<li>${message}</li>`; // Actualizar el contenido del contenedor de errores
    errorContainer.style.display = 'block'; // Asegurarse de que el contenedor de errores es visible
}
